...
from STYLEGAN2_1.layers_1.dense_layer import DenseLayer
from STYLEGAN2_1.layers_1.synthesis_main_layer import SynthesisMainLayer
from STYLEGAN2_1.layers_1.to_rgb_layer import ToRgbLayer
from STYLEGAN2_1.utils_stylegan2 import nf
from STYLEGAN2_1.weights_map import available_weights, synthesis_weights, mapping_weights, weights_stylegan2_dir
...
class SynthesisNetwork(tf.keras.layers.Layer):
    ...
    def call(self, dlatents_in):
        ...
        for res in range(3, self.resolution_log2 + 1):
            ...
            y = tf.keras.layers.UpSampling2D(y, interpolation='bilinear')
